...
-- Recriar função calculate_machine_oee com search_path
...
-- Recriar get_machine_statistics com search_path
...
-- Recriar get_losses_by_type com search_path
...
-- Recriar get_downtime_analysis com search_path
...
-- Recriar get_daily_trends com search_path
